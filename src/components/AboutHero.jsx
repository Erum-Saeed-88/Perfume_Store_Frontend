...
const AboutHero = () => {
  ...
  const backgroundImage = "https://mir-s3-cdn-cf.behance.net/project_modules/1400/cb95e6207555229.66dfef2da0921.gif";

  return (
    <section className="relative w-full h-[65vh] md:h-[55vh] flex items-center justify-center overflow-hidden bg-stone-950">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        {/* Subtle Upper Accent */}
        <div className="mb-3 flex justify-center mt-40">
